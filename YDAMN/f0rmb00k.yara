...
{
meta:
	description = "Identifies Formbook malware"
strings: 
	$str1 = "www.liangyuen528.com" nocase
	$str2 = "www.3xfootball.com" nocase
...
rule Mal_Formbook_IMPHASH
{
    meta:
        description = "Identifies known Formbook imphash"
        imphash = "91d07a5e22681e70764519ae943a5883"
    condition:
        pe.imphash() == "91d07a5e22681e70764519ae943a5883"
}
